...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: firsthome(),
      //  home: firsthome(),
      // initialRoute: '/CompleteProfileScreen',
      // routes: {
      //   '/': (context) => firsthome(),
      ...
      //   '/gmail_register': (context) => gmail_register(usermodel: usermodel, firebaseuser: firebaseuser,),
      //   '/chat_home': (context) => chat_home(),
      //   '/ChatPage': (context) => MessagePage(),
      //   '/status_page': (context) => status_page(),
      //   '/call_page': (context) => call_page(),
      //           '/CompleteProfileScreen': (context) => CompleteProfileScreen(usermodel: usermodel, firebaseuser: firebaseuser,)
